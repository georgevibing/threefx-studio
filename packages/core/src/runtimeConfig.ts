...
export function createWispySmokeRuntimeConfig(
  ...
  return {
    ...
    emitters: [
      {
        ...
        scale: vec3Value(values, "sourceScale", [0.95, 0.38, 0.95]),
        shape: "sphere",
    ...
    fields: [
      {
        ...
        curlStrength: numberValue(values, "curlStrength", 4),
        id: "curl_field",
        ...
        type: "curl",
        vorticityConfinement: numberValue(values, "vorticityConfinement", 5),
      },
    ],
    forces: [
      {
    ...
    obstacles: [],
    render: {
      absorption: numberValue(values, "absorption", 0.96),
      baseDensity: numberValue(values, "baseDensity", 1.35),
      blendMode,
      ...
      detailStrength: numberValue(values, "detailStrength", 4.4),
      ...
      scattering: numberValue(values, "scattering", 2.85),
  ...
  const fields = nodes
    ...
    .map((node) => {
      ...
      return {
        ...
        speed: numberValue(values, "detailSpeed", 0.9),
        strength: node.type === "field.fbm" ? numberValue(values, "detailStrength", 4.4) : numberValue(values, "turbulence", 2.45),
