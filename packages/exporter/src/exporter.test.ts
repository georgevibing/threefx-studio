...
describe("@threefx/exporter", () => {
  it("exports a typed WispySmokeVFX source package", () => {
    ...
    expect(exported.mainClassSource).toContain("attributeArray");
    ...
    expect(exported.usageSnippet).toContain("renderStepScale: 0.42");
    expect(exported.usageSnippet).toContain("pressureIterations: 18");
  });
